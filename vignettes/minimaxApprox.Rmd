...
-- useful when the function's magnitude varies enormously over the interval
and a uniform absolute tolerance would waste accuracy where the function is
small and starve it where the function is large:
...
Here the two are close but not identical -- exactly the kind of gap the
